...
[Download full CV (PDF)](/files/CV_Latu_Kalita.pdf){: .btn .btn--primary}
...
* **Indian Institute of Technology (IIT) Guwahati** — July 2024 - July 2025
  ...
  * *Floquet-Driven Superconducting Diode Effect in a Helical Shiba Chain* — demonstrated a traveling-wave drive-induced superconducting diode effect with tunable non-reciprocal critical currents and coexisting Floquet Majorana modes, requiring no external magnetic field; analyzed via self-consistent Bogoliubov-de Gennes formalism. (manuscript in preparation)
  * *Floquet Hybrid-Order Topology and Z2-like Bipolar Skin Localization* — showed that periodic driving activates first-order helical edge states coexisting with higher-order corner modes in a BBH lattice, and uncovered a drive-controlled unipolar-to-bipolar skin localization transition characterized via a non-Bloch Floquet GBZ framework.
  * *Non-Hermitian Topology and Floquet Skin Effect* (M.Sc. Thesis) — studied skin effect and bulk-boundary correspondence breakdown in the SSH model and 2D p-wave superconductor models using generalized Brillouin zone (GBZ) construction and Floquet formalism.

* **Cotton University, Guwahati** — June 2023
  * Supervisor: Dr. Mridula Baro, Assistant Professor, CU
  * Synthesized biomass-derived porous carbon nanomaterials via hydrothermal carbonization of bamboo powder with ZnCl₂ activation for energy storage applications.
...
======
* **Junior Research Fellowship** (2025 - present) — Offered a JRF position in the ANRF-funded project *"Theoretical study of robust topological quantum systems and their characterization,"* under Dr. Suraj S. Hegde, IISER Thiruvananthapuram.
* **Inspire Scholarship** (2020 - 2025) — Awarded by the Department of Science and Technology (DST), India, for academic excellence in science.
* **Gold Medalist** (2023) — First rank, B.Sc. Physics, Cotton University (CGPA 9.43).
* **Anundoram Barooah Award** (2018) — Government of Assam, India, for outstanding performance in the matriculation exam.

National Exams Qualified
======
* **CSIR-UGC NET, December 2025 (Physics)** — All India Rank 174/22,533; qualified for UGC-JRF and Assistant Professor eligibility.
* **GATE 2025 (Physics)** — All India Rank 325/19,225.
...
Outreach
======
* Attended the 66th Department of Atomic Energy Symposium on Nuclear Physics (2022).
* Completed an NPTEL course by IIT Guwahati on "Numerical Methods and Simulation Techniques for Scientists and Engineers" (2021).
* Participated in the 23rd National Children's Science Congress (2015) as a Child Scientist, presenting *"A Comparative Study on Locally Used Fuel (Firewood)."*

Languages
======
* English (proficient — medium of instruction for all academic degrees), Hindi (native), Assamese (mother tongue)
